...
<body>
	...
	<main>
	<h1 class="slideInDown animated">Welcome Teacher</h1>
	<div class="form-style-5 slideInDown animated">
		...
		<fieldset>
			<legend><span class="number"></span> Hear You Go...</legend>
			...
			<div class="input-group">
				...
				<button type="submit" name="product" formaction="teacher_details.php" class="btn"><b>TEACHER DETAILS</b></button><br/>
			    <button type="submit" name="supplier" formaction="student_details.php" class="btn"><b>STUDENTS DETAILS</b></button><br/>
		        <button type="submit" name="customer" formaction="student_home.php" class="btn"><b>COURSES</b></button><br/>
