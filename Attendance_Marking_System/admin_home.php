	...
	<div class="form-style-5 slideInDown animated">
		...
		<fieldset>
			...
			<div class="input-group">
				...
				<button type="submit" name="product" formaction="products.php" class="btn"><b>TEACHER MANAGEMENT</b></button><br/>
			    <button type="submit" name="supplier" formaction="supplier.php" class="btn"><b>STUDENTS MANAGEMENT</b></button><br/>
		        <!--<button type="submit" name="customer" formaction="customer.php" class="btn"><b>COURSES</b></button><br/>-->
